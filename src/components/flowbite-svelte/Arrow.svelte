<script lang="ts">
  import type { ArrowProps } from 'flowbite-svelte';
...
<div
  use:positioning
  class="popover-arrow clip pointer-events-none absolute block h-2.5 w-2.5 border-b border-l border-inherit bg-inherit text-inherit {className}">
</div>
