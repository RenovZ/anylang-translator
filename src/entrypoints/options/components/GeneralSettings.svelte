  ...
  <div class="mt-10 space-y-10">
    <div class="grid grid-cols-[1fr_220px] items-start gap-8">
      <div>
        ...
        <p class="mt-1 text-sm text-slate-400">指定您希望将内容翻译成的语言</p>
      </div>
      <select
    ...
    <div class="grid grid-cols-[1fr_220px] items-start gap-8">
      <div>
        ...
        <p class="mt-1 text-sm text-slate-400">选择翻译后的显示方式：双语对照或仅显示译文</p>
      </div>
      <select
    ...
    <div class="grid grid-cols-[1fr_220px] items-start gap-8">
      <div>
        ...
        <p class="mt-1 text-sm text-slate-400">当网站为下列域名时，会自动翻译为目标语言</p>
    ...
    <div class="grid grid-cols-[1fr_220px] items-start gap-8">
      <div>
        ...
        <p class="mt-1 text-sm text-slate-400">当页面中某一段落的语言为下列语言时，将跳过翻译</p>
      </div>
      <select
        class="focus:border-primary-400 w-full rounded-xl border border-slate-300 bg-white px-4 py-3 transition outline-none">
        <option>编辑</option>
    ...
    <div class="grid grid-cols-[1fr_220px] items-start gap-8">
      <div>
        ...
        <p class="mt-1 text-sm text-slate-400">区分译文的样式，具体可参考下列示例</p>
    ...
    <div class="grid grid-cols-[1fr_220px] items-start gap-8">
      <div>
        <div class="text-lg font-semibold">当页面语言和目标语言为相近语言时，为译文添加背景色</div>
        <p class="mt-1 text-sm text-slate-400">
